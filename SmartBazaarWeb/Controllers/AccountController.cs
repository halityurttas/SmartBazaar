...
namespace SmartBazaar.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            {
                return RedirectToAction("Login", "Admin/AdminManager");
            }
        ...
        public ActionResult Register()
        {
            ...
            ViewBag.Gender = Models.Common.CustomerEntityListProvider.GetGenderList().Select(item => new SelectListItem { Text = item.Value, Value = item.Key.ToString() }).ToList();
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { Id = userId.ToString(), UserName = model.Email, Email = model.Email, EmailConfirmed = true };
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string mailContent = this.RenderRazorView("Mails/ForgotPassword", callbackUrl);
                await UserManager.SendEmailAsync(user.Id, "Parola Sıfırlama", mailContent);
