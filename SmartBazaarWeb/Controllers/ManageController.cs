...
namespace SmartBazaar.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult AddAddress()
        {
            ...
            ViewBag.Districts = LocationWalker.GetDistrict(1).Select(s => new SelectListItem { Value = s.Title, Text = s.Title });
        ...
        public ActionResult AddAddress(CustomerAddressViewModel model)
        {
            ...
            ViewBag.Cities = LocationWalker.GetCities().Select(s => new SelectListItem { Value = s.Id.ToString(), Text = s.Title, Selected = s.Id == int.Parse(model.City) });
            ViewBag.Districts = LocationWalker.GetDistrict(1).Select(s => new SelectListItem { Value = s.Title, Text = s.Title, Selected = s.Title == model.District });
            return View(model);
        }
        ...
        public ActionResult AddressEdit(int id)
        {
            ...
            ViewBag.Cities = cities.Select(s => new SelectListItem { Value = s.Id.ToString(), Text = s.Title, Selected = s.Title == model.City });
            ViewBag.Districts = LocationWalker.GetDistrict(cities.FirstOrDefault(f => f.Title == model.City).Id).Select(s => new SelectListItem { Value = s.Title, Text = s.Title, Selected = s.Title == model.District });
        ...
        public ActionResult AddressEdit(Models.Site.CustomerAddressViewModel model)
        {
            ...
            ViewBag.Cities = LocationWalker.GetCities().Select(s => new SelectListItem { Value = s.Id.ToString(), Text = s.Title });
            ViewBag.Districts = LocationWalker.GetDistrict(int.Parse(model.City)).Select(s => new SelectListItem { Value = s.Title, Text = s.Title });
            return View(model);
        }
